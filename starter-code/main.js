      ...
      rl.question('Type an option: ', (option) => {
        switch (option) {
          ...
          case "3":
            ...
            case "4":
              // 4.- List by name all companies founded in february of 2004. Hecho
              ...
              case "5":
                ...
                db.collection('companies').find({ $and: [{founded_year: 2004 }, {founded_month: { $gt:4, $lt: 6 } }] }, { name: 1, _id: 0 }).toArray((error, result) => {
                  if (error) {
                    console.log(error);
                    rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
                  } else {
                ...
                case "6":
                  // 6.- What companies have offices in "Barcelona". Hecho
                  ...
                  case "10":
                    ...
                    case "11":
                      ...
                      db.collection('companies').findOne({$and: [{"name": "Facebook"}, {"relationships.is_past": false}]}, { "relationships.person.first_name": 1, "relationships.person.last_name": 1, _id: 0 }, (error, result) => {
                        if (error) {
                          console.log(error);
                          rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
                        } else {
                    ...
                    case "12":
                      ...
                      db.collection('companies') .find({"relationships.person.permalink": "david-ebersman" }, { "name": 1, _id: 0 }) 
